...
# Logs on the working directory on the file named runner.log
...
def main():
    ...
    for device in pbar(devices):
        ...
        try:
            ...
            # Log the successful connection on the working directory in runner.log
            ...
            # Log the successful configuration on the working directory in runner.log
            ...
            # Log the authentication error on the working directory in runner.log
            ...
            # Log the TCP/22 connectivity error on the working directory in runner.log
